...
namespace IridiumJS.Runtime.Environments
{
    ...
    public abstract class EnvironmentRecord : ObjectInstance
    {
        ...
        /// <summary>
        ///     Delete a binding from an environment record. The String value N is the text of the bound name If a binding for N
        ///     exists, remove the binding and return true. If the binding exists but cannot be removed return false. If the
        ...
        /// <summary>
        ///     Returns the value to use as the <c>this</c> value on calls to function objects that are obtained as binding values
        ///     from this environment record.
        /// </summary>
