...
namespace IridiumJS.Native.Function
{
    public class BindFunctionInstance : FunctionInstance, IConstructor
    {
        ...
        {
            var f = TargetFunction.TryCast<FunctionInstance>(x => { throw new JavaScriptException(Engine.TypeError); });
        ...
        {
            var target = TargetFunction.TryCast<IConstructor>(x => { throw new JavaScriptException(Engine.TypeError); });
